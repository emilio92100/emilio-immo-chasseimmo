...
/* L'en-tête d'une rubrique (Visites, Mes clients) : le titre et ses chiffres
   ...
   Sur ordinateur : un fond crème, les tuiles blanches posées dessus, le
   filtre en cours en bleu clair. Sur téléphone : une carte blanche compacte,
   la recherche sous le titre, les chiffres en bandeau qui défile au doigt.
