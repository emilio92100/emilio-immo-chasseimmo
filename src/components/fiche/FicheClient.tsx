...
Description originale : ${editBienForm.description}`,
  ...
  async function saveFicheBien() {
    ...
    await supabase.from('biens').update({ photos: photosFinales,
      ...
      nb_pieces: parseInt(editBienForm.nb_pieces)||null, nb_chambres: parseInt(editBienForm.nb_chambres)||null, etage: parseInt(editBienForm.etage)||null,
